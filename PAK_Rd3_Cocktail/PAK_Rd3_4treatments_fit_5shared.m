...
excelFileName = 'dataset_PAK_Rd3.xlsx';
sheetName = 'PAK_Rd3_Grouped';
...
eps_init = [0.0058, 1e-5, 0.0440, 0.0317];       % Decreasing with MOI
gamma_init = [0.5120, 0.5286, 0.5678, 0.3716];          % Fitness cost
delta_init = [1e-3, 1e-3, 1e-3, 1e-6];         % Resistance acquisition
phi_s_init = [5.303e-9, 5.4502e-9, 5.3349e-9, 3.1896e-8];       % Adsorption rate
R0_init = [5.03e6, 5.03e6, 1.7666e6, 2.0619e5];                % Initial resistant
...
title(t_layout, 'PAK Rd3 Cocktail: Global Fitting Results with M1 (5 shared parameters)', ...
...
exportgraphics(fig1, 'PAK_Rd3_4treatment_fit_5shared.pdf', 'ContentType', 'vector', 'Resolution', 300);
...
title(t_layout2, 'PAK Rd3 Cocktail: Treatment-Specific Parameters vs MOI (All 4 Treatments)', ...
...
exportgraphics(fig2, 'PAK_Rd3_4treatment_params_5shared.pdf', 'ContentType', 'vector', 'Resolution', 300);
...
save('fitting_results_4treatments_PAK_Rd3_5shared.mat', 'results');
