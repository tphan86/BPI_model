...
title(tl1, 'Model Fit Comparison for Y-3650 Fern: M1 (shared a_{rs}, a_{sr}) vs M2 (treatment-specific a_{rs}, a_{sr})', ...
...
exportgraphics(fig1, 'Y3650F_fit_comparison_M1vsM2.pdf', ...
    'ContentType','vector','Resolution',300);
fprintf('Figure 1 saved: Y3650F_fit_comparison_M1vsM2.pdf\n');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FIGURE 2 – Residual Analysis (Systematic Bias)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

fig2 = figure('Units', 'inches', 'Position', [0.5, 0.5, 16, 10]);
tl2  = tiledlayout(3, 4, 'TileSpacing', 'compact', 'Padding', 'compact');
title(tl2, 'Residual Analysis for Y-3650 Fern: M1 vs M2', ...
    'FontSize', 18, 'FontWeight', 'bold');
...
for col = 1:n_treatments
    ...
    ylabel('RMSE (CFU/mL)', 'FontSize', 12);
    title(sprintf('RMSE: %s', treatment_names{col}), 'FontSize', 14);
    text(1, rmse_m1*1.05, sprintf('%.2e', rmse_m1), ...
        'HorizontalAlignment','center','FontSize',10);
    text(2, rmse_m2*1.07, sprintf('%.2e', rmse_m2), ...
        'HorizontalAlignment','center','FontSize',10);
    grid on; set(gca,'FontSize',12);
    ylim([0, 1.6*1e8]);
end

exportgraphics(fig2, 'Y3650F_residuals_comparison_M1vsM2.pdf', ...
    'ContentType','vector','Resolution',300);
fprintf('Figure 2 saved: Y3650F_residuals_comparison_M1vsM2.pdf\n');
