%% Profile Likelihood Analysis (parfor-accelerated)
...
%    Y3650F_profile_likelihood_results.mat            <- all computed profile data
%    Y3650F_profile_likelihood_interspecific.pdf      <- Figure 1: R^2 profile curves
%    Y3650F_profile_optimal_values.pdf               <- Figure 2: bar chart
%    Y3650F_profile_likelihood_interpretation.pdf    <- written interpretation + ms text
%
%  PREREQUISITES:
%    fitting_results_4treatments_Y3650F_5shared.mat          (M1 results)
%    fitting_results_4treatments_Y3650F_3shared.mat          (M2 results)
%    dataset_Y3650F.xlsx
...
m1             = load('fitting_results_4treatments_Y3650F_5shared.mat');
a_rs_M1_shared = m1.results.shared.a_rs;
a_sr_M1_shared = m1.results.shared.a_sr;
M1_R2          = m1.results.R_squared(:);

% --- M2 starting points ---
m2          = load('fitting_results_4treatments_Y3650F_3shared.mat');
r2          = m2.results;
...
save('Y3650F_profile_likelihood_results.mat', 'profile_results');
fprintf('Saved : Y3650F_profile_likelihood_results.mat\n\n');
...
title(tl1,'Y3650F Profile Likelihood: Per-Treatment Optimal a_{rs} and a_{sr}', ...
...
exportgraphics(fig1,'Y3650F_profile_likelihood_interspecific.pdf', ...
    'ContentType','vector','Resolution',300);
fprintf('Saved : Y3650F_profile_likelihood_interspecific.pdf\n');
...
title(tl2,['Y3650F Treatment-Specific Optimal a_{rs} and a_{sr}: ' ...
...
exportgraphics(fig2,'Y3650F_profile_optimal_values.pdf', ...
    'ContentType','vector','Resolution',300);
fprintf('Saved : Y3650F_profile_optimal_values.pdf\n');

% % =========================================================================
% % 12. Call Python to generate interpretation PDF
% % =========================================================================
% fprintf('\nGenerating interpretation PDF...\n');
% [status, msg] = system('python3 generate_interpretation_pdf.py');
% if status == 0
%     fprintf('Saved : profile_likelihood_interpretation.pdf\n');
% else
